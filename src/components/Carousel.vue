<template>
    <div class="carousel">
        ...
        <i :style="{ cursor: 'pointer', fontSize: '30px'}" class="fa fa-chevron-right" @click="prevSlide"></i>
    </div>
</template>
